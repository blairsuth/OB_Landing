  ...
  return (
    <Layout>
      <section>
        ...
        <article>
          <p>This website and any mobile application (collectively, this “Site”) is owned by Onebook Inc (“<b>We</b> ”, “<b>Us</b>” or “<b>Onebook Inc</b>”). We are providing you with access to this Site and our online store (together, our “<b>Services</b>”) subject to the following terms and conditions.</p>
          <p>By browsing, accessing, using, registering for or purchasing services on this Site or otherwise using our Services, you are agreeing to all of the following terms and conditions, including any policies referred to herein (collectively, these “<b>Terms</b>”). So, please read these Terms carefully. We reserve the right to change this Site and these Terms at any time. If you are unwilling to be bound by these Terms, you should not browse, access‚ use‚ register for or purchase merchandise from the Site.</p>
          <p>You represent and warrant that you are at least 18 years old or visiting this Site under the supervision of a parent or guardian.</p>
        </article>

        <article>
          <h2>Privacy Policy</h2>
          <p>Our Privacy Policy, which also governs your visit to Our Site, can be found [
            <a
              className="bg-yellow-100 hover:underline"
              target="_blank"
              rel='noreferrer'
              href="https://docs.google.com/document/d/1AP6hjsxT1E1kZvP04a-N7vBQzvq31onLrzA2pwR6Uyg/edit?usp=sharing">
              here
             </a>]
          </p>
          <p>Please review our Privacy Policy for information on how We collect, use and share information about our users.</p>
        </article>

        <article>
          <h2>Use of This Site</h2>
          <p className="italic">Intended Audience. This website and/or associated App is intended for anyone interested in finding a service professional in their area. The intent of the content is to provide a constructive and clear pathway to find service professionals in your area as well as book an appointment with them.</p>
          <p>Subject to your compliance with these Terms, we grant you a limited‚ non-exclusive‚ non-transferable‚ non-sublicensable license to access and make personal‚ non-commercial use of this Site. This license grant does not include: (a) any resale or commercial use of this Site or content therein; (b) the collection and use of any professional listings or descriptions; (c) making derivative uses of this Site and its contents; or (d) use of any data mining‚ robots‚ or similar data gathering and extraction methods on this Site. You may not use‚ frame or utilize framing techniques to enclose any of Our trademark‚ logo‚ content or other proprietary information (including the images found at this Site‚ the content of any text or the layout/design of any page or form contained on a page) without Our express written consent. Further, you may not use any meta tags or any other “<i>hidden text</i>” utilizing Our name, trademark‚ or product name without Our express written consent. Any breach of these Terms shall result in the immediate revocation of the license granted in this paragraph without notice to you.</p>
        ...
        <article>
          ...
          <h2>User Content</h2>
          <p>This Site may include features and functionality (“<b>Interactive Features</b>”) that allows users to create, post, transmit or store any content, such as text, music, sound, photos, video, graphics or code on the Sites ("<b>User Content</b>"). User Content is publicly-viewable and may include your profile information and any content you post pursuant to your profile, but it does not include your account information or information you submit in order to make a purchase. You agree that you are solely responsible for your User Content and for your use of Interactive Features, and that your use any Interactive Features at your own risk.</p>
          <p>By using any Interactive Areas, you agree not to post, upload to, transmit, distribute, store, create or otherwise publish or send through the Sites any of the following:</p>
          <ul>
        ...
        <article>
          ...
          <p>Our Copyright Agent for Notice of claims of copyright infringement on the Site is [Ian Imamura], who can be reached as follows:</p>
          <p>By Mail: <address>1538 Spring Water Pl <br /> Highlands Ranch <br /> CO 80129</address></p>
          <p>By Phone: <a href="tel:+17192524047" className="bg-yellow-100 hover:underline">+17192524047</a></p>
          <p>By Email: <a href="mailto:ian@onebook.ai?subject=About%20OneBook.ai%20Terms%20of%20service" className="bg-yellow-100 hover:underline">ian@onebook.ai</a></p>
        </article>

        <article>
          <h2>Feedback</h2>
          <p>Separate and apart from User Content, you may have the ability to submit questions, comments suggestions, reviews, ideas, plans, designs, notes, proposals, drawings, original or creative materials and other information regarding this Site, Us and our products or services (collectively "<b>Feedback</b>"). You agree that Feedback is non-confidential and shall become Our sole property. We shall own exclusive rights, including all intellectual property rights, in and to such Feedback and shall be entitled to the unrestricted use and dissemination of the Feedback for any purpose, commercial or otherwise, without acknowledgment or compensation to you.</p>
        </article>

        <article>
          <h2>Restrictions on Rights to Use</h2>
          <p>You agree you shall not (and you agree not to allow any other individual or entity using your password and identification to):</p>
          <ul>
            ...
            <li>create or transmit to other users unsolicited electronic communications‚ such as “<i>spam</i>‚” or otherwise interfere with other users’ enjoyment of the Site;</li>
        ...
        <article>
          <h2>Ownership</h2>
          <p>As between you and Us‚ this Site‚ including all photographs‚ images‚ text‚ graphics‚ icons‚ audio clips‚ software‚ source code and other aspects thereof (excluding User Content)‚ all improvements or modifications thereof‚ all derivative works based thereon‚ and the collection‚ arrangement‚ and assembly of this Site (collectively, the “<b>Site Content</b>”)‚ including all copyrights‚ trademarks‚ and other intellectual property or proprietary rights in the foregoing‚ are owned by Us or our licensors and protected by applicable copyright laws.</p>
          <p>The use of any of Our trademarks or service marks without our express written consent is strictly prohibited. You may not use our trademarks or service marks in connection with any product or service in any way that is likely to cause confusion. You may not use our trademarks or service marks in any manner that disparages or discredits us. You may not use any of our trademarks or service marks in meta tags without prior explicit consent. Nothing in these Terms shall be deemed to grant to you or any other user any license or right in or to any of Our patents‚ copyrights‚ trademarks‚ trade secrets or other proprietary rights.</p>
        </article>
        ...
        <article>
          ...
          <p>Any issues arising from purchasing and hiring professionals through this Site must be handled between the professional, the professional's business and you.</p>
          <p>We may charge sales tax for services ordered on this Site based on the applicable state sales tax rate of the location to which the service is being provided.</p>
          <p>When We provide services to you per your directions to another person, you agree to pay the appropriate charges shown on this Site when your order is placed. All charges to the CUSTOMER/SERVICE are handled and charged by the business after a service is completed per specific service price standards set forth by the business. We reserve the right to increase, decrease and add or eliminate charges from time to time and without prior notice, so you agree to check all charges before placing an order or signing up for a service.</p>
          <p>Only valid credit cards or other payment methods acceptable to us may be used. By submitting your order, you represent and warrant that you are authorized to use the designated card or method and authorize us to charge your order (including taxes, shipping, handling and any other amounts described on the Sites) to that card or other method. If the card (or other method) cannot be verified, is invalid, or is not otherwise acceptable, your order may be suspended or cancelled automatically.</p>
          <p>We attempt to be as accurate as possible and eliminate errors on this Site; however, We do not warrant that any product, service, description, photograph, pricing or other information is accurate, complete, reliable, current or error-free. In the event of an error, whether on this Site, in an order confirmation, in processing an order, delivering a professional or service or otherwise, We reserve the right to correct such error and revise your order accordingly if necessary (including charging the correct price) or to cancel the order and refund any amount charged. Your sole remedy in the event of such error is to cancel your order and obtain a refund.</p>
          <p>All services are subject to availability and We reserve the right to impose limits on any product and/or services, to reject all or part of an order or booking and to discontinue products or services without notice, even if you have already made a booking. All prices are subject to change without notice. We reserve the right to refuse or cancel any bookings placed for products and/or services in which the sale or use of such product and/or service in your state or jurisdiction is restricted or prohibited.</p>
        </article>

        <article>
          <h2>Links</h2>
          <p>This Site may contain links to other sites on the Internet that are owned and operated by third parties. You acknowledge that We are not responsible for the operation of or content located on or through any such site.</p>
        </article>
        ...
        <article>
          ...
          <p>To the fullest extent permitted by applicable law, you agree to defend, indemnify and hold harmless Us and our subsidiaries and affiliates, and our respective officers, directors, agents, partners, members, employees, independent contractors, service providers and consultants ("<b>Our Related Parties</b>"), from and against any claims, damages, costs, liabilities and expenses (collectively, "<b>Claims</b>") arising out of or related to (a) your access to and use or misuse of this Site; (b) any User Content you post, upload, use, distribute, store or otherwise transmit on or through this Site; (c) any Feedback that you provide; (d) your violation of these Terms; and (e) your violation of any rights of another. You agree to promptly notify Us of any third party Claims, cooperate with Us in defending such Claims and pay all fees, costs and expenses associated with defending such Claims (including but not limited to attorneys' fees). You further agree that the We shall have the right to control the defense or settlement of any third party Claims.</p>
        </article>

        <article>
          <h2>Disclaimers</h2>
          <p>Except as expressly provided, this Site, including all Site Content, and services provided on or in connection with this Site are provided on an "<b>AS IS</b>" and "<b>WITH ALL FAULTS</b>" basis without representations, warranties or conditions of any kind, either express or implied. WE DISCLAIM ALL OTHER REPRESENTATIONS, WARRANTIES, CONDITIONS AND DUTIES, EXPRESS, IMPLIED OR STATUTORY, INCLUDING BUT NOT LIMITED TO IMPLIED WARRANTIES, DUTIES OR CONDITIONS: (A) OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE OR USE, RESULTS, TITLE, AND NON-INFRINGEMENT; AND (B) CREATED BY TRADE USAGE, COURSE OF DEALING OR COURSE OF PERFORMANCE. We does not represent or warrant that this Site is accurate, complete, reliable, current or error-free. We do not represent or warrant that this Site or our servers are free of viruses or other harmful components.</p>
        </article>

        <article>
          <h2>Exclusivity of Remedy; Limitation of Liability</h2>
          <p>Your sole and exclusive remedy, and Our sole and exclusive liability, for any breach of warranty shall be your right to return the product, or receive a refund for the service under Our applicable returns and exchanges policies. IN NO EVENT SHALL WE OR OUR RELATED PARTIES, BE LIABLE FOR SPECIAL, INDIRECT, INCIDENTAL, OR CONSEQUENTIAL DAMAGES, INCLUDING LOST PROFITS OR LOSS OF BUSINESS, EVEN IF THEY HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES, NOR SHALL OUR AND OUR RELATED PARTIES’ AGGREGATE LIABILITY, WHETHER IN CONTRACT, WARRANTY, TORT (INCLUDING NEGLIGENCE, WHETHER ACTIVE, PASSIVE OR IMPUTED), OR OTHER THEORY, ARISING OUT OF OR RELATING TO THESE TERMS OR THE PURCHASE OR USE OF ANY PRODUCTS OR SERVICES PURCHASED THROUGH THIS SITE EXCEED THE PURCHASE PRICE OF THE PRODUCT OR SERVICE. THE LIMITATIONS SET FORTH IN THIS PARAGRAPH WILL NOT LIMIT OR EXCLUDE OUR OR OUR RELATED PARTIES’ GROSS NEGLIGENCE, FRAUD, INTENTIONAL, WILLFUL, MALICIOUS OR RECKLESS MISCONDUCT.</p>
        </article>

        <article>
          <h2>Remedies</h2>
          <p>You agree that our remedy at law for any actual or threatened breach of these Terms would be inadequate and that we shall be entitled to specific performance or injunctive relief, or both, in addition to any damages that we may be legally entitled to recover, together with reasonable expenses of any form of dispute resolution, including, without limitation, attorneys' fees.</p>
          <p>No right or remedy of ours shall be exclusive of any other, whether at law or in equity, including without limitation damages injunctive relief, attorneys' fees and expenses.</p>
        </article>

        <article>
          <h2>Applicable Law</h2>
          <p>You agree that this agreement shall be subject to the laws of the State of Colorado, without regard to conflicts of laws provisions will govern these Terms and Condition of Use and any dispute that may arise between you and Operator or its affiliates.</p>
        </article>
        ...
        <article>
          <h2>Severability</h2>
          <p>If any of these provisions shall be deemed invalid, void, or for any reason unenforceable, that condition shall be deemed several and shall not affect the validity and enforceability of any remaining provision.</p>
        </article>

        <article>
          <h2>No Third-Party Beneficiaries</h2>
          <p>These Terms are for the benefit of, and will be enforceable by, the parties only. These Terms are not intended to confer any right or benefit on any third party or to create any obligations or liability of a party to any such third party.</p>
        </article>

        <article>
          <h2>Miscellaneous</h2>
          <p>No agency, partnership, joint venture, or employment relationship is created as a result of these Terms‚ and you do not have any authority of any kind to bind Us in any respect whatsoever. We may provide you with notices‚ including those regarding changes to these Terms‚ by email‚ regular mail‚ or postings on this Site. These Terms, which shall be deemed accepted by you upon your use of the Site, constitute the entire agreement among you and Us regarding use of this Site. Our failure to exercise or enforce any right or provision of these Terms shall not constitute a waiver of the enforcement of such right or provision. If any provision of these Terms is found to be unenforceable or invalid, that provision shall be limited or eliminated to the minimum extent necessary so that these Terms shall otherwise remain in full force and effect and enforceable. These Terms are not assignable‚ transferable or sublicensable by you‚ except with our prior written consent. These Terms include and incorporate by reference Our Privacy Policy, which can be found [
      <a
              className="bg-yellow-100 hover:underline"
              target="_blank"
              rel='noreferrer'
      ...
      , and any notices regarding the Site.
    </p>
        </article>

        <article>
          <h2>Questions</h2>
          <p>Questions regarding these Terms, Our Privacy Policy, or other policy related material can be directed to our support staff by emailing us at: <a className="bg-yellow-100 hover:underline" href="mailto:privacy@onebook.ai">privacy@onebook.ai</a>.</p>
        </article>
